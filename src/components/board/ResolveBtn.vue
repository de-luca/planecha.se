<template>
  <button @click="resolver" class="button is-light is-outline is-rounded" title="Resolve">
...
class Props {
  public resolver = prop<() => void>({ required: true });
}

export default class ResolveBtn extends Vue.with(Props) {}
</script>
